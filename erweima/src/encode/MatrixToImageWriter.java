...
public class MatrixToImageWriter {
    private static  int BLACK = 0xFF000000;//用于设置图案的颜色  0xFF000000黑色
    private static  int WHITE = 0xFFFFFFFF; //用于背景色  0xFFFFFFFF 白色
...
//                image.setRGB(x, y,  (matrix.get(x, y) ? Color.YELLOW.getRGB() : Color.RED.getRGB()));
            }
        }
        return image;
    }
